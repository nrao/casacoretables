...
try:
    from casacoretables.tables import (msconcat, removeDerivedMSCal,
                                        addDerivedMSCal, removeImagingColumns,
                                        addImagingColumns, complete_ms_desc,
                                        required_ms_desc, default_ms,
                                        default_ms_subtable)
    HAVE_MS = True
except ImportError:
    HAVE_MS = False
